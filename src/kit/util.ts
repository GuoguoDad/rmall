...
import { NavigationRouteConfigMap, NavigationState } from 'react-navigation'
 ...
 */
export const getActiveRouteName = (navigationState: NavigationState): string => {
  if (!navigationState) {
    return ''
  }
 ...
 * @param name
 */
export const isValidPage = (routes: NavigationRouteConfigMap, name: string) => {
