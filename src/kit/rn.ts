import { NavigationInjectedProps, NavigationRoute, NavigationScreenProp, NavigationState } from 'react-navigation'

import navigate from '@argojs/react-native-navigate'
 ...
 */
export const rnBack = (navigation: NavigationInjectedProps['navigation']) => {
